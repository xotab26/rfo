...
VERSION = 0.1.0
CC      = g++
CFLAGS  = -fsanitize -g3 -Wall -Werror -pedantic -Wextra -Wno-unknown-pragmas -D_DEBUG -DUNIX_BUILD -DMYSQLPP_MYSQL_HEADERS_BURIED -DMYSQLPP_NO_DLL -DVERSION=\"$(VERSION)\" -std=c++11
CXXFLAGS= 
